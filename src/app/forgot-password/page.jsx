    ...
    return (
        <div className="min-h-dvh bg-white">
            <div className="mx-auto flex min-h-dvh w-full max-w-[600px] flex-col bg-white">
                ...
                {/* Header */}
                <header className="relative h-[120px] overflow-hidden bg-[#00D061] px-5 pt-6">
                    <Image
                    ...
                    <div className="relative z-10 flex items-center gap-3 pt-1">
                        <button
                            ...
                            onClick={() => router.back()}
                            aria-label="Go back"
                            className="flex h-9 w-9 items-center justify-center rounded-[10px] border border-white/80 bg-white/10 text-white transition hover:bg-white/20"
                        >
                            <svg
                                width="18"
                                height="18"
