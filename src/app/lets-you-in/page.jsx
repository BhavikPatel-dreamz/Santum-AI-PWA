            ...
            <div className="w-full max-w-[600px] flex flex-col min-h-dvh bg-[#E4FFEE] relative">
                ...
                <div className="relative bg-[#00D061] h-94 flex items-end justify-center pb-12 overflow-hidden flex-shrink-0">
                    ...
                    {/* Circuit SVG background */}
                     <img src="/icons/let-you-screen-main-img.jpg" alt="Amigo logo" className="absolute top-0 max-w-[800px] h-full" />
                    ...
                    <div className="absolute top-21 z-10 w-[120px] h-[120px] bg-white rounded-[24px] flex items-center justify-center">
                        <div className="flex items-center justify-center">
                            <img src="/icons/logo.png" alt="Amigo logo" className="w-22 h-22 object-contain" />
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute z-10 w-[96%] mx-3 top-59 bg-white rounded-[28px] px-7 pt-8 pb-9">
                    ...
                    <div className="flex justify-center gap-4 mb-6">
                        ...
                        <a href="https://www.facebook.com" target="_blank" rel="noreferrer" aria-label="Continue with Facebook"
                            className="w-[60px] h-[60px] rounded-[14px] border border-gray-200 flex items-center justify-center bg-white hover:border-[#2bb673] hover:shadow-[0_4px_12px_rgba(43,182,115,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                        ...
                        {/* WhatsApp */}
                        <a href="https://wa.me/+12345678899" target="_blank" rel="noreferrer" aria-label="Continue with WhatsApp"
                            className="w-[60px] h-[60px] rounded-[14px] border border-gray-200 flex items-center justify-center bg-white hover:border-[#2bb673] hover:shadow-[0_4px_12px_rgba(43,182,115,0.15)] hover:-translate-y-0.5 transition-all duration-200">
...
">
                ...
                <footer className="text-center py-6 pb-8 px-4 font-satoshi">
                    <p className="text-[18px] leading-6 text-[#555] text-center px-4">
                        ...
                        <a href="/sign-up" className="text-[#0F0F0F] font-semibold hover:underline px-1">
                            Sign up
                        </a>
                    </p>
                </footer>
