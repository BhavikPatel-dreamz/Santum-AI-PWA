  ...
  return (
    <div>
      <div className="flex justify-center gap-4 mb-6">
        ...
        {/* Apple */}
        <buttoon className="w-[60px] h-[60px] rounded-[14px] border border-gray-200 flex items-center justify-center bg-white hover:border-[#2bb673] hover:shadow-[0_4px_12px_rgba(43,182,115,0.15)] hover:-translate-y-0.5 transition-all duration-200">
